...
namespace Assignment_6
{
    internal class Program
    {
        ...
        {
            //ASSIGNMENT 6 - GROUP 9 - ONLY THE ODD ONES! (1,3,5 AND 7);
            ...
            while (true)
            {
                ...
                //---------------------------BEGINING OF EXERCISES----------------------------------------------------------------------------------------------------
                switch (option)
                {
                    case 1:

                        //CASE 1 VARIABLE
                        int decision = 1, numberN = 0;
                        ...
                        while (decision == 1)
                        {
                            ...
                            while (!Int32.TryParse(Console.ReadLine(), out numberN))
                            {
                                Console.Clear();
                                Console.WriteLine("\n\n\n\n\n\n\n\n");
                                Console.WriteLine("PLEASE USE ONLY NUMBERS. TRY AGAIN");
                            ...
                            while (numberN < 1)
                            {
                                Console.Clear();
                                Console.WriteLine("\n\n\n\n\n\n\n\n");
                                Console.WriteLine("NUMBER HAVE TO BE GREATER OR EQUAL TO 1. TRY AGAIN");
                                Thread.Sleep(500);
                                Console.Write("REDIRECTING TO THE QUESTION");
                                Thread.Sleep(500);
                                Console.Write(".");
                            ...
                            Console.WriteLine("\n");
                            Console.WriteLine($"The smallest number is 1 and the largest number is {numberN}");
                            Thread.Sleep(1000);
                    ...
                    case 4:
                        ...
                        while (anotherTry == 1)
                        {
                            ...
                            while (!Int32.TryParse(Console.ReadLine(), out numberChosen))
                            {
                                Console.Clear();
                                Console.WriteLine("\n\n\n\n\n\n\n\n");
                                Console.WriteLine("PLEASE USE ONLY NUMBERS. TRY AGAIN");
                            ...
                            if (numberChosen < 1)
                            {
                                Console.Clear();
                                Console.WriteLine("\n\n\n\n\n\n\n\n");
                                Console.WriteLine("THE NUMBER MUST BE GREATER OR EQUAL TO 1");
                                Thread.Sleep(500);
                                Console.Write("REDIRECTING TO THE QUESTION");
                                Thread.Sleep(500);
                                Console.Write(".");
                            ...
                            while (!Int32.TryParse(Console.ReadLine(), out anotherTry))
                            {
                                Console.Clear();
                                Console.WriteLine("\n\n\n\n\n\n\n\n");
                                Console.WriteLine("PLEASE USE ONLY NUMBERS");
                    ...
                    default:
                        Console.Clear();
                        Console.WriteLine("\n\n\n\n\n\n\n\n");
                        Console.WriteLine("WRONG EXERCISE NUMBER. PLEASE TRY AGAIN");
                        Thread.Sleep(500);
                        Console.Write("REDIRECTING TO MENU");
                        Thread.Sleep(500);
                        Console.Write(".");
